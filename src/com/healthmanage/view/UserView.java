...
public class UserView extends View {
    ...
    public String selectLogin() {
        return getMenuInput("USERMODE LOGIN",
                "[1] 로그인       [2] 회원가입       [0] 종료");
    }

    public String selectMenu() {
        return getMenuInput("USER MODE",
                "[1] 나의 출결         [2] 운동 시간      [3] 체중 관리\n" +
                "[4] 운동 기구         [5] 쿠폰 사용      [6] 코인 관리\n" +
                "[7] 비밀번호 변경      [0] 로그아웃");
    }
    ...
    public String TimeSelectMenu() {
        return getMenuInput("WORKOUT TIME",
                "[1] 오늘의 운동 시간     [2] 날짜별 조회     [3] 월별 누적 조회\n" +
                "[4] 전체 누적 조회       [0] 메인 메뉴");
    }
