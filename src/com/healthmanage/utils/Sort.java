...
public class Sort {
	...
	public static Collection<Coupon> sortCoupon(Collection<Coupon> list) {
		return list.stream().sorted(Comparator.comparing(Coupon::getNumber)).collect(Collectors.toList());
	}
	...
	public static Map<String, String> sortRank2(Map<String, String> list) {
		return list.entrySet().stream().sorted(Map.Entry.comparingByValue())
